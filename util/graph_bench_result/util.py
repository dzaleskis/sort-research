...
def build_implementation_meta_info():
    ...
    meta_info = {
        ...
        "rust_glidesort_stable_synergistic": (palette[3], "triangle"),
        ...
        "rust_driftsort_stable_synergistic": (palette[6], "circle"),
        "rust_max_mergesort_stable": (palette[2], "circle"),
        "rust_max_stable_synergistic": (palette[2], "circle"),
        # Unstable
        "c_crumsort_unstable_synergistic": (palette[4], "square"),
        ...
        "rust_max_unstable_synergistic": (palette[7], "circle"),
        ...
        "merge_routine_gallop_modified": (palette[6], "circle"),
