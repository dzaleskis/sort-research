...
# lentele kur bendri slowdownai kiekvieno algoritmo
...
for algo in algos:
    ...
    type_slowdown_results.append(['combined', algo, algo_geom_mean_slowdown])
...
type_slowdown_df.to_csv(f"tables/{prefix}_combined_slowdown_benchmark_results.csv", float_format='%.2f',  index=False)
